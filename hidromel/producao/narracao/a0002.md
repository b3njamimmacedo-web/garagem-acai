# Como estudar: a ordem que funciona

> Módulo 00 — A Ordem
> Aula `a0002` · duração alvo 6 min · ~3 imagens

**O que o aluno sai sabendo:** Por que assistir na sequência importa aqui: fermentação tem tempo biológico, e há uma aula que precisa começar hoje para render no módulo 5.

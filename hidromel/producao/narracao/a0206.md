# Calculando seu mosto do zero

> Módulo 02 — A Ciência do Mel
> Aula `a0206` · duração alvo 16 min · ~8 imagens

**O que o aluno sai sabendo:** Da garrafa que você quer para o kg de mel que precisa comprar. Usando a Calculadora da Ordem, dentro da área de membros.

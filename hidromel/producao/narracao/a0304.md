# Protocolo TOSNA/SNA passo a passo

> Módulo 03 — Leveduras e Fermentação
> Aula `a0304` · duração alvo 17 min · ~9 imagens

**O que o aluno sai sabendo:** A adição escalonada de nutriente que virou padrão-ouro. Cronograma exato em dias, dose por litro, e a versão simplificada para quem está começando.

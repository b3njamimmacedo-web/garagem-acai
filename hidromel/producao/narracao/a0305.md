# Temperatura, pH e oxigênio

> Módulo 03 — Leveduras e Fermentação
> Aula `a0305` · duração alvo 16 min · ~8 imagens

**O que o aluno sai sabendo:** Os três parâmetros de controle. Como fazer controle de temperatura sem câmara fria gastando R$ 60. Quando o pH trava a fermentação (stuck).

# Setup comercial: 200 a 1.000 litros/mês

> Módulo 04 — Equipamentos e Sanitização
> Aula `a0403` · duração alvo 18 min · ~9 imagens

**O que o aluno sai sabendo:** Dimensionamento real da sala de produção, com planta baixa e orçamento por faixa de volume. Pré-requisito do módulo de legalização.

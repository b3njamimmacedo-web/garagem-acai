# Limpeza x sanitização: não é a mesma coisa

> Módulo 04 — Equipamentos e Sanitização
> Aula `a0404` · duração alvo 12 min · ~6 imagens

**O que o aluno sai sabendo:** A confusão que arruina lotes. PBW, percarbonato, soda cáustica — quando usar cada um.

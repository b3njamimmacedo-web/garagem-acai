# Montando sua bancada de trabalho

> Módulo 04 — Equipamentos e Sanitização
> Aula `a0406` · duração alvo 11 min · ~6 imagens

**O que o aluno sai sabendo:** Fluxo sujo → limpo, superfícies, armazenamento de insumos e o layout que evita contaminação cruzada.

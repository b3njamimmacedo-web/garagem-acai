# Dia 0 — sanitizar e montar o mosto

> Módulo 05 — Seu Primeiro Hidromel
> Aula `a0502` · duração alvo 24 min · ~12 imagens

**O que o aluno sai sabendo:** Aula prática integral, sem corte. Pesagem, diluição, medição de OG, correção de pH e inoculação.

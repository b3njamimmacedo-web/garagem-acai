# Backsweetening: adoçando sem explodir garrafa

> Módulo 05 — Seu Primeiro Hidromel
> Aula `a0507` · duração alvo 18 min · ~9 imagens

**O que o aluno sai sabendo:** Sorbato + metabissulfito, dose correta e a conta de risco. A aula que evita a garrafa estourando no armário do cliente.

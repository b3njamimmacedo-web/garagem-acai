# Metheglin — o hidromel das especiarias

> Módulo 06 — Receitas Medievais Clássicas
> Aula `a0601` · duração alvo 19 min · ~10 imagens

**O que o aluno sai sabendo:** Do galês "meddyglyn", bebida medicinal. Canela, cravo, gengibre, noz-moscada. Receita fechada + quando adicionar cada especiaria.

**O que muda em relação à base:** Extrato frio de especiarias e a adição na secundária, provando a cada 12 h.

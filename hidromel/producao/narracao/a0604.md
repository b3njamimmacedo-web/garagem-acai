...
> Aula `a0604` · duração alvo 17 min · ~9 imagens

**O que o aluno sai sabendo:** A ponte entre hidromel e vinho. Tinto e branco, e o hippocras (pyment com especiarias) das cortes medievais.

**O que muda em relação à base:** Tanino enológico no mosto e a escolha de cepa tinta.
...
- `a0603` Cyser — mel e maçã (Módulo 06)

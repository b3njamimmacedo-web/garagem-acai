...
> Aula `a0605` · duração alvo 18 min · ~9 imagens

**O que o aluno sai sabendo:** O híbrido cerveja-hidromel do País de Gales. Mostura simplificada, proporções e o lúpulo na medida certa.

**O que muda em relação à base:** ETAPA NOVA: mostura do malte, fervura e lúpulo. O mel entra só depois de resfriar.

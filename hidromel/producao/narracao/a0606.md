# Bochet — o mel caramelizado

> Módulo 06 — Receitas Medievais Clássicas
> Aula `a0606` · duração alvo 22 min · ~11 imagens

**O que o aluno sai sabendo:** A técnica medieval mais impressionante: cozinhar o mel até caramelizar. Notas de toffee, marshmallow e chocolate. O passo a passo com segurança — mel a 130°C queima gente.

**O que muda em relação à base:** ETAPA NOVA: caramelizar o mel a 130 °C. Filmada integralmente, com as precauções de segurança.

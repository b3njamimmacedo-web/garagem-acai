# T'ej etíope e o gesho

> Módulo 06 — Receitas Medievais Clássicas
> Aula `a0609` · duração alvo 16 min · ~8 imagens

**O que o aluno sai sabendo:** A tradição viva mais antiga do mundo. Como substituir o gesho (Rhamnus prinoides) com ingrediente disponível no Brasil.

**O que muda em relação à base:** Chá de gesho (e o substituto brasileiro), fermentação quente e por que NÃO clarificar.
...
- `a0601` Metheglin — o hidromel das especiarias (Módulo 06)

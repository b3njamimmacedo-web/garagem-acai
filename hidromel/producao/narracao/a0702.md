# Clarificação natural pelo tempo

> Módulo 07 — Estabilização e Clarificação
> Aula `a0702` · duração alvo 11 min · ~6 imagens

**O que o aluno sai sabendo:** A opção gratuita: como sedimentar em frio e trasfegar em cascata. Quanto tempo realmente leva.

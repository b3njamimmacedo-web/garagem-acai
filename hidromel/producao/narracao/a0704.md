# Estabilização química: sorbato e sulfito

> Módulo 07 — Estabilização e Clarificação
> Aula `a0704` · duração alvo 17 min · ~9 imagens

**O que o aluno sai sabendo:** A dupla que impede refermentação. Doses por litro em função do pH, e por que a ordem de adição importa.

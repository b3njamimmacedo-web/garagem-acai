# Carbonatação: natural x forçada

> Módulo 07 — Estabilização e Clarificação
> Aula `a0706` · duração alvo 19 min · ~10 imagens

**O que o aluno sai sabendo:** Priming com açúcar (com a conta de segurança), contrapressão e barril. Como fazer hidromel espumante sem bomba de fragmentação.

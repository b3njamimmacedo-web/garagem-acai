# Teste de estabilidade antes de vender

> Módulo 07 — Estabilização e Clarificação
> Aula `a0707` · duração alvo 14 min · ~7 imagens

**O que o aluno sai sabendo:** O protocolo de 30 dias que evita devolução de lote inteiro: garrafa-teste em estufa, choque térmico e prova cega.

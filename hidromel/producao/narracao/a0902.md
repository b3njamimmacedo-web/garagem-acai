# Óleo fúsel, solvente e "esquenta garganta"

> Módulo 09 — Diagnóstico de Defeitos
> Aula `a0902` · duração alvo 13 min · ~7 imagens

**O que o aluno sai sabendo:** Fermentação quente demais. Como identificar e o que a maturação consegue ou não consertar.

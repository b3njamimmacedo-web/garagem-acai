# A lógica do produto que ninguém tem

> Módulo 10 — Linha Premium: Receitas Inusitadas
> Aula `a1001` · duração alvo 16 min · ~8 imagens

**O que o aluno sai sabendo:** Por que receita inusitada não é capricho: é a única forma de fugir da comparação de preço. O critério para inventar sem errar.

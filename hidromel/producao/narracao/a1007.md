# Braggot de café torrado e cacau nibs

> Módulo 10 — Linha Premium: Receitas Inusitadas
> Aula `a1007` · duração alvo 18 min · ~9 imagens

**O que o aluno sai sabendo:** Corpo de stout, alma de hidromel. O produto que converte bebedor de cerveja artesanal.

**O que muda em relação à base:** Tostar os nibs a 150 °C e o cold brew nos últimos 3 dias da secundária.

**Não repita estas etapas** — já foram ensinadas e a área de membros
linka para elas:
- `a0605` Braggot — mel e malte (Módulo 06)

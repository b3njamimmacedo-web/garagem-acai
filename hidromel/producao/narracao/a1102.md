# CNPJ: MEI serve? CNAE e enquadramento

> Módulo 11 — Legalização
> Aula `a1102` · duração alvo 20 min · ~10 imagens

**O que o aluno sai sabendo:** A resposta direta: fabricação de bebida alcoólica NÃO é permitida no MEI. Quais CNAEs usar, ME x EPP, Simples Nacional e o custo mensal real.

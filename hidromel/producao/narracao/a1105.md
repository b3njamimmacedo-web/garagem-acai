# Análise laboratorial: o laudo por lote

> Módulo 11 — Legalização
> Aula `a1105` · duração alvo 17 min · ~9 imagens

**O que o aluno sai sabendo:** Físico-química obrigatória: ABV, acidez, densidade, açúcares, metanol. Laboratórios credenciados e custo por análise.

# Vigilância sanitária e boas práticas de fabricação

> Módulo 11 — Legalização
> Aula `a1107` · duração alvo 18 min · ~9 imagens

**O que o aluno sai sabendo:** Alvará, planta, POPs e manual de BPF. O checklist do fiscal — e como estar pronto para ele.

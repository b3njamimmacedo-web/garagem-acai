# Impostos: IPI, ICMS, Simples e nota fiscal

> Módulo 11 — Legalização
> Aula `a1108` · duração alvo 21 min · ~11 imagens

**O que o aluno sai sabendo:** Bebida alcoólica tem carga tributária alta. A conta completa para não descobrir o imposto depois de definir o preço.

# Preço por canal: direto, feira, bar e distribuidor

> Módulo 12 — Custos e Precificação
> Aula `a1205` · duração alvo 20 min · ~10 imagens

**O que o aluno sai sabendo:** A mesma garrafa tem 4 preços. Como montar a tabela para não brigar com o próprio revendedor.

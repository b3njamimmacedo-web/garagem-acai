# Degustação: o script que fecha venda

> Módulo 14 — Vendas
> Aula `a1404` · duração alvo 20 min · ~10 imagens

**O que o aluno sai sabendo:** A sequência de 7 minutos numa feira: aborda, conta a história, serve, pergunta, fecha. Palavra por palavra.

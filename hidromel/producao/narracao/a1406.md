# Feiras e eventos: a conta que precisa fechar

> Módulo 14 — Vendas
> Aula `a1406` · duração alvo 17 min · ~9 imagens

**O que o aluno sai sabendo:** Custo de estande, estoque a levar, ponto de equilíbrio do dia e o pós-evento que gera recompra.

# Distribuidor: quando vale abrir mão de margem

> Módulo 14 — Vendas
> Aula `a1407` · duração alvo 16 min · ~8 imagens

**O que o aluno sai sabendo:** O cálculo de quando o volume compensa o desconto, e as cláusulas de exclusividade que prendem produtor pequeno.

# Recompra: clube de assinatura de hidromel

> Módulo 14 — Vendas
> Aula `a1409` · duração alvo 19 min · ~10 imagens

**O que o aluno sai sabendo:** O modelo de maior valor por cliente. Como estruturar níveis, precificar e reter — com a matemática do LTV.

# Contratando: as duas primeiras pessoas

> Módulo 15 — Escala
> Aula `a1504` · duração alvo 17 min · ~9 imagens

**O que o aluno sai sabendo:** Quem contratar primeiro, custo real de um funcionário e as alternativas legais para operação pequena.
